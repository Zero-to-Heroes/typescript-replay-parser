...
export class ImagePreloaderService {
  ...
  public readonly STATIC_IMAGES = {
    ...
    mana:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/mana.png",
    manaSpent:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/mana_spent.png",
    manaLocked:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/mana_locked.png",
    // Used in JS
    raceBanner:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/card/race-banner.png",
    frameMinionPremium:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/card/frame-minion-premium.png",
    frameHeroPower:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/hero/hero_power.png",
    ...
    heroFrame:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/hero/hero_frame.png",
    heroFramePremium:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/hero/hero_frame_premium.png",
    nameBannerSpell:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/card/name-banner-spell.png",
    nameBannerMinion:
    ...
    exhausted:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/exhausted.png",
    iconDeathrattle:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/effects/icon_deathrattle.png",
    iconPoisonous:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/effects/icon_poisonous.png",
    iconLifesteal:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/effects/icon_lifesteal.png",
    iconInspire:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/effects/icon_inspire.png",
    iconTrigger:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/effects/icon_trigger.png",
    overlayImmune:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/minion_immune.png",
    overlayDivineShield:
    ...
    overlayFrozen:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/minion_frozen.png",
    overlayStealth:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/minion_stealth.png",
    overlayElusive:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/minion_elusive.png",
    overlayWindfury:
    ...
    heroOverlayImmune:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/hero_immune.png",
    ...
    heroOverlayFrozen:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/hero_frozen.png",
    enchantmentRing:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/enchantments/enchantment-ring.png",
    rarityCommon:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/card/rarity-common.png",
    rarityRare:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/card/rarity-rare.png",
    rarityEpic:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/card/rarity-epic.png",
    rarityLegendary:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/card/rarity-legendary.png",
    attack:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/attack.png",
    health:
      "https://static.zerotoheroes.com/hearthstone/asset/manastorm/health_new.png",
    armor:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/armor.png",
    damage:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/icon_damage.png",
    heal:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/icon_heal.png",
    burned:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/overlays/burned.png",
    mulliganDiscard:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/mulligan_discard.png",
    cardback:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/cardback.png",
    quest:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/secrets/quest_button.png",
    questBang:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/secrets/quest_bang.png",
    questInfo:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/secrets/quest_info_arrow.png",
    secretQuestionMark:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/secrets/secret_question_mark.png",
    fatigue:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/fatigue.png",
    victoryScreen:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/victory_screen.png",
    lossScreen:
      "https://static.zerotoheroes.com/hearthstone/asset/coliseum/images/loss_screen.png"
  };
  public readonly CLASS_IMAGES = {
    ...
    secretFrame: playerClass => {
      if (
        ["warlock", "druid", "priest", "neutral"].indexOf(playerClass) !== -1
      ) {
        return null;
      }
  ...
  private buildImageUrls(history: readonly HistoryItem[]): readonly string[] {
    ...
    const withDuplications = [
      ...cardArtUrls,
      ...staticImageUrls,
      ...dynamicImageUrls
    ];
    return withDuplications.filter(
      (item, index) => withDuplications.indexOf(item) === index
    );
  }
}
